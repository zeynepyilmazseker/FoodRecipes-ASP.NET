    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="auto-style30">
        <div class="auto-style6">
            ...
            <table class="auto-style19">
                <tr>
                    <td class="auto-style39"><strong>&nbsp;Mesajlar&nbsp; </strong></td>
            ...
            <table class="auto-style19">
                <tr>
                    <td class="auto-style40"><strong>
                        <asp:Label ID="Label1" runat="server" CssClass="auto-style25" Text='<%# Eval("MesajGonderen") %>'></asp:Label>
                        </strong></td>
                    <td class="auto-style26">
                        <a href="MesajDetay.aspx?Mesajid=<%#Eval("Mesajid") %>"><asp:Image ID="okundu" runat="server" Height="30px" ImageUrl="~/resimler/okundu.png" Width="30px" /></a>
                        </td>
                </tr>
            </table>
        </ItemTemplate>
