        ...
        <table class="auto-style13">
            <tr>
                <td class="auto-style16"><strong><a href="YemekDetay.aspx?Yemekid=<%# Eval("Yemekid") %>">
                    <asp:Label ID="Label3" runat="server" CssClass="auto-style14" Text='<%# Eval("YemekAd") %>'>
            ...
            <tr>
                <td style="height:auto;"><strong>Malzemeler:</strong>
                    <asp:Label ID="TxtMalzemeler" runat="server" Text='<%# Eval("YemekMalzeme") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="height:auto;"><strong>Yapılış:</strong>
                    <asp:Label ID="TxtYapilis" runat="server" Text='<%# Eval("YemekTarif") %>'></asp:Label>
                </td>
            </tr>
            <tr>
                <td><strong>Tarih:</strong>
                    <asp:Label ID="TxtTarih" runat="server" Text='<%# Eval("YemekTarih") %>'></asp:Label>
                        &nbsp;<strong> Puan:</strong> <strong>
                    <asp:Label ID="TxtPuan" runat="server" Text='<%# Eval("YemekPuan") %>'></asp:Label>
                    </strong></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
